...
namespace bx
{
	...
	template<typename Ty>
	inline void zeros4(Ty* _ptr)
	{
		memSet(_ptr, 0, sizeof(Ty) * 16);
	}


	template<typename Ty>
	void mtxCpy(Ty* _dst, const Ty* _src)
	{
		memcpy(_dst, _src, 16 * sizeof(Ty));
	}
} // namespace bx
